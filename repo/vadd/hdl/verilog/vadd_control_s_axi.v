...
localparam
    ...
    ADDR_IN1_DATA_1   = 6'h14,
    ADDR_IN1_CTRL     = 6'h18,
    ADDR_IN2_DATA_0   = 6'h1c,
    ADDR_IN2_DATA_1   = 6'h20,
    ADDR_IN2_CTRL     = 6'h24,
    ADDR_OUT_R_DATA_0 = 6'h28,
    ADDR_OUT_R_DATA_1 = 6'h2c,
    ADDR_OUT_R_CTRL   = 6'h30,
    ADDR_SIZE_DATA_0  = 6'h34,
    ADDR_SIZE_CTRL    = 6'h38,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
