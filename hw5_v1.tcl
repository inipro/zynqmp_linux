...
################################################################
# This is a generated script based on design: hw5
#
...
if { $list_projs eq "" } {
   file delete -force hw5
   create_project hw5 hw5 -part xczu3eg-sbva484-1-e
...
proc create_root_design { parentCell } {
  ...
  set ctsn [ create_bd_port -dir I ctsn ]
  set rtsn [ create_bd_port -dir O rtsn ]
  ...
  connect_bd_net -net axi_uart16550_0_rtsn [get_bd_ports rtsn] [get_bd_pins axi_uart16550_0/rtsn]
  connect_bd_net -net axi_uart16550_0_sout [get_bd_ports txd] [get_bd_pins axi_uart16550_0/sout]
  connect_bd_net -net ctsn_0_1 [get_bd_ports ctsn] [get_bd_pins axi_uart16550_0/ctsn]
  connect_bd_net -net emio_uart0_ctsn_0_1 [get_bd_ports BT_ctsn] [get_bd_pins zynq_ultra_ps_e_0/emio_uart0_ctsn]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net sin_0_1 [get_bd_ports rxd] [get_bd_pins axi_uart16550_0/sin]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_uart0_rtsn [get_bd_ports BT_rtsn] [get_bd_pins zynq_ultra_ps_e_0/emio_uart0_rtsn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] -force
